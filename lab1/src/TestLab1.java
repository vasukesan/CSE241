...
public class TestLab1 {
    ...
    public void testClosestPair() {
        ...
        Sort.msort(pointsByX, lessThanX);
        Sort.msort(pointsByXExpected, lessThanX);
        Sort.msort(pointsByY, lessThanY);
        Sort.msort(pointsByYExpected, lessThanY);
        // IF YOU WANT, IMPLEMENT A BRUTE FORCE CLOSEST PAIR TO TEST YOUR METHOD.
//         lab1.Result rMinExpect =
//            ClosestPair.findClosestPairBruteForce(pointsByXExpected,
//                pointsByYExpected);
        ...
        //System.out.println(rMinExpect.printf() + "   "+rMin.printf());
